...
angular.module('Cameras')
    .controller('CamerasController', ['$rootScope', '$scope', '$location', 'HTTPService', 'toastr',
        function($rootScope, $scope, $location, HTTPService, toastr) {
            ...
            $scope.load = function(id) {
                ...
                HTTPService.getAll('cameras', '', $scope.limit, $scope.currentPage, null, {
                    id: 'name',
                    asc: true
                }, function(response) {
                    $scope.loadingList = false;

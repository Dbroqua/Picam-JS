...
angular.module("Authentication").controller("AuthenticationController",["$rootScope","$scope","$location","HTTPService",function(e,s,n,o){"use strict";e.title=TITLEPrefix+"Login",e.bodyClass="text-center signin",s.message=null,s.$on("$destroy",function(){e.bodyClass=""}),s.username="",s.password="",s.login=function(){s.message=null,""!==s.username&&""!==s.password?o.login(s.username,s.password,function(){n.path("/cameras/")},function(e){if(null!==e&&void 0!==e.status)switch(e.status){case 401:s.message="Bad login";break;default:s.message="Unknown error"}else s.message="Server downn ?"}):s.message="<strong>Error !</strong> Malformed form"}}]);

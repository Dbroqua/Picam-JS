...
angular.module("User").controller("UserController",["$rootScope","$scope","$location","$routeParams","HTTPService","toastr","$ngBootbox",function(s,t,a,r,o,i,n){s.title=TITLEPrefix+"User",t.User={},t.updatedValues={},t.userId=null,t.isLoading=!0,t.patchUser=function(e,s){o.patch("users",e,s,function(e){200===e.status?(i.success("Action completed"),t.load()):i.error("Can't complete this operation")})},t.updateUser=function(){var e=!1,s=function(){t.isLoading=!0,"add"!==r.id?o.patch("users",t.userId,t.updatedValues,function(e){t.isLoading=!1,200===e.status?(i.success("Action completed"),t.load()):i.error("Can't complete this operation")}):o.post("users",t.updatedValues,function(e){if(t.isLoading=!1,201===e.status)i.success("New user created"),a.path("/administration/users/"+e.data._id);else switch(e.status){case 409:i.error("Can't create new user because this email or this apikey is already in use");break;default:i.error("Can't create new user")}})};delete t.updatedValues.infos,"add"===r.id&&0===t.updatedValues.password.length&&(e=!0),!1===e?s():n.confirm("No password set, are you sure?").then(function(){s()},function(){console.log("Confirm dismissed!")})},t.deleteUser=function(){t.isLoading=!0,o.delete("users",t.userId,function(e){200===e.status?(i.success("User deleted"),a.path("/administration/users/")):(t.isLoading=!1,i.error("Can't remove this user"))})},t.generateApiKey=function(){var e="",s="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%&*-_=+";for(_i=0;_i<32;_i++)e+=s.charAt(Math.floor(Math.random()*s.length));t.updatedValues.apikey=e},t.load=function(){t.User={},"add"!==r.id?(t.userId=r.id,o.getOne("users",r.id,null,function(e){if(t.isLoading=!1,200===e.status)t.User=e.data,t.updatedValues=e.data,delete t.updatedValues._id,s.title=TITLEPrefix+t.User.first_name+t.User.last_name;else switch(e.status){case 401:i.error("Not authorized");break;case 404:i.error("User not found");break;case 500:i.error("Internal server error");break;default:i.error("Can't show this user")}})):(t.User={},t.updatedValues={},t.generateApiKey(),t.showEditableValues=!0,t.isLoading=!1)},t.load()}]);

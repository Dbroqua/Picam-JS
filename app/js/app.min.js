...
angular.module("HomePage").controller("HomePageController",["$rootScope","$scope","HTTPService",function(o,l,e){"use strict";o.title=TITLEPrefix+"Homepage",l.loadingList=!0,l.Monitoring={},e.getAll("sys","",null,null,null,null,function(o){l.loadingList=!1,200===o.status&&(console.log(o.data),l.Monitoring=o.data)})}]);

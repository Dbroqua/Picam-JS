...
angular.module("Network",[]).factory("HTTPService",["$rootScope","$http","$base64","$cookies","$q","$ngBootbox",function(l,r,n,o,c,u){var s={authDatas:o.get("PiCam")||null,userData:null,getAll_cancel:{},getOne_cancel:{},isLogged:function(){return null!==s.authDatas},initEnv:function(){r.defaults.headers.common.Authorization="Basic "+s.authDatas},get:function(e,a,n,t){var i=t||c.defer();return a&&null!==a?a.timeout=i.promise:a={timeout:i.promise},r.get(SERVER_PATH+e,a).then(n,n),i},getRemote:function(e,a,n,t){var i=t||c.defer(),l={method:"GET",url:e,data:null};return a&&null!==a?a.timeout=i.promise:a={timeout:i.promise},l.data=a,r(l).then(n,n),i},patch:function(e,a,n,t){r.patch(SERVER_PATH+e+"/"+a,n).then(t,t)},post:function(e,a,n){r.post(SERVER_PATH+e+"/",a).then(n,n)},delete:function(e,a,n,t){var i=n;void 0===t&&(t=n,i="Are you sure to want delete this element ?"),u.confirm(i).then(function(){r.delete(SERVER_PATH+e+"/"+a).then(t,t)},function(){console.log("Confirm dismissed!")})},generateAuthorizationHeader:function(e,a){return n.encode(e+":"+a)},login:function(e,a,n,t){var i=this.generateAuthorizationHeader(e,a);r.defaults.headers.common.Authorization="Basic "+i,r.post(APIUri+"authenticate",{username:e,password:a}).then(function(e){var a=e.data;s.authDatas=i,s.userData=a,console.log(a),l.apikey=a.apikey,n&&(o.put("PiCam",i),n())},function(e){t&&t(e)})},relogin:function(a,n){null===s.userData&&r.post(APIUri+"authenticate",null).then(function(e){s.userData=e.data,l.apikey=e.data.apikey,a&&a()},function(e){n&&n(e)})},logout:function(e){s.authDatas=null,o.remove("PiCam"),r.defaults.headers.common.Authorization=null,e()},parseFilters:function(e){var a,n="";for(a in e)Array.isArray(e[a].values)?0<e[a].values.length&&(""!==n&&(n+="&"),n+="q."+e[a].name+"."+e[a].func+"="+e[a].values):"null"!==e[a].values&&""!==e[a].values&&(""!==n&&(n+="&"),n+="q."+e[a].name+"."+e[a].func+"="+e[a].values);return n},getAll:function(e,a,n,t,i,l,r){var o="",c=e+a;s.getAll_cancel[e]&&(s.getAll_cancel[e].resolve(),s.getAll_cancel[e]=void 0),typeof l===Object&&(o=l.id,l.asc||(o="-"+o)),c+="?limit="+n+"&page="+t+"&sort="+o+"&",s.getAll_cancel[e]=s.get(c+s.parseFilters(i),null,r,s.getAll_cancel[e])},getAllRemote:function(e,a,n){var t=e.sort.col;s.getAll_cancel[a]&&(s.getAll_cancel[a].resolve(),s.getAll_cancel[a]=void 0),e.sort.dir||(t="-"+t),s.getAll_cancel[a]=s.getRemote(e.scheme+"://"+e.uri+":"+e.port+"/api/v1/cameras/?apikey="+e.apikey+"&sort="+t,e,n,s.getAll_cancel[a])},getOne:function(e,a,n,t){s.getOne_cancel[e]&&(s.getOne_cancel[e].resolve(),s.getOne_cancel[e]=void 0),s.getOne_cancel[e]=s.get(e+"/"+a+"?"+n,null,t,s.getOne_cancel[e])},returnPagination:function(e,a,n){var t,i,l=Math.ceil(e/(0<a?a:1)),r={list:[],nbPages:l,currentPage:n};for(t=0;t<l;t++)i=t+1,r.list.push({index:i,active:n===i});return r}};return s}]).directive("pagination",function(){return{restrict:"E",template:'<ul class="pagination">   <li ng-class="{disabled: pagination.currentPage === 1}">       <a href="javascript:void(0)" ng-click="pagination.currentPage > 1 && load( pagination.currentPage - 1 )" aria-label="Previous">           <span aria-hidden="true">&laquo;</span>       </a>   </li>   <li class="disabled" ng-repeat-start="p in pagination.list" ng-if="$index > 2 && $index === (pagination.currentPage - 5) ">       <a href="javascript:void(0)">...</a>   </li>   <li ng-class="{active : p.active}" ng-if="$index < 3 || ( $index > (pagination.currentPage - 5) && $index < (pagination.currentPage + 3) ) ||        $index > ( pagination.nbPages - 4 )">       <a href="javascript:void(0)" ng-click="load(p.index)">{{p.index}}</a>   </li>   <li class="disabled" ng-if="$index <= ( pagination.nbPages - 4 ) && $index === (pagination.currentPage + 3) " ng-repeat-end>       <a href="javascript:void(0)">...</a>   </li>   <li ng-class="{disabled: pagination.currentPage === pagination.nbPages}">       <a href="javascript:void(0)" ng-click="pagination.currentPage < pagination.nbPages && load(pagination.currentPage + 1)" aria-label="Next">           <span aria-hidden="true">&raquo;</span>       </a>   </li></ul>'}});
angular.module("HomePage").controller("HomePageController",["$rootScope","$scope","$interval","toastr","HTTPService",function(o,t,i,e,r){"use strict";o.title=TITLEPrefix+"Homepage",t.isLoading=!0,t.Monitoring={},t.lastRefresh=null,t.monitoring=function(){t.isLoading=!0,t.lastRefresh=null,r.getAll("sys","",null,null,null,null,function(o){t.loadingList=!1,200===o.status&&(t.isLoading=!1,t.Monitoring=o.data,t.Monitoring.memory.usage=Math.round(100*t.Monitoring.memory.used/t.Monitoring.memory.total),t.Monitoring.disks.root.usage=Math.round(100-100*t.Monitoring.disks.root.free/t.Monitoring.disks.root.total),t.Monitoring.disks.boot.usage=Math.round(100-100*t.Monitoring.disks.boot.free/t.Monitoring.disks.boot.total),t.lastRefresh=moment().format("DD/MM/YYYY H:m:s"))})},t.reboot=function(){r.delete("sys/uptime",null,"Are you sure you want to reboot this Pi?",function(o){202===o.status?e.info("This Pi will reboot in few seconds"):e.error("Error when trying to restart this Pi")})},$('[data-toggle="tooltip"]').tooltip(),t.monitoring()}]).directive("sysProgressBar",function(){return{restrict:"E",scope:{value:"=value",title:"@"},templateUrl:"templates/progress-bar.html"}});
